...
# Return the coordinates of corner points of the selected rectangle
...
# checks if the mouse is on or near to the possible corner point
...
# Draw the corner points and edges
...
# Let users adjust the predicted coornonates by dragging
def adjust_coor_quad(image,rect):
	...
	# nested function for drag-and-drop
